...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        var app = angular.module('ManagerBonus', [])
                ...
                <div class="col-lg-offset-4 col-md-offset-3 col-sm-offset-1 col-xs-offset-1 col-lg-4 col-md-6 col-sm-10 col-xs-10 form-white form-top-change-password form-box">
                    <div class="form-head">
                        <div class="accelerator col-lg-9 pull-left">
                            <a href="#"><span>
                                <img src="images/dg_icon_bonus.png"></span> <span>Manager Bonus</span></a>
                        </div>
                    ...
                    <div class="collapse" id="manager_list">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <select class="form-control custom-select" id="sel1" data-ng-controller="samplecontrol">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="form-label" for="form-start-noti">
                                    Amount</label>
                                <%--<input type="text" name="form-username" placeholder="1000" class="form-username form-control" id="form-username">--%>
                                <asp:TextBox runat="server" class="form-username form-control" ID="formusername"
                                    ng-model="Amount"></asp:TextBox>
                                <%--{{Amount}}--%>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="col-lg-4 col-md-offset-4">
                                ...
                                <asp:Button ID="btnSubmit" runat="server" Text="Submit" class="btn btn-info btn-lg" />
                            </div>
                            <div class="col-lg-4 ">
                                <%--<button type="submit" class="btn">Cancel</button>--%>
                                <asp:Button ID="btnCancel" runat="server" Text="Cancel" class="btn btn-danger btn-lg" />
                            </div>
                            <br />
                            <br />
                        </div>
